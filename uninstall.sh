...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    sudo apt-get remove -y python3-pil python3-numpy python3-requests python3-rpi.gpio python3-spidev python3-feedparser python3-dateutil python3-astral >> $LOG_FILE 2>&1
